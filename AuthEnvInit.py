...
class AuthServiceConfigAssembler:
    ...
    def construct_config_file(self) -> None:
        ...
        email_queue = os.environ.get('EMAIL_QUEUE', f'{stage}-{self.__project_name}-email-queue.fifo')
        ...
        if self.__input_environment == 'test' or stage == 'test':
            ...
            frontend_url = self.__get_parameter(f'{parameter_store_prefix}/frontend-url-{self.__stage}', decrypt=False)
